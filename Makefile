...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
REAL_CC		= /home/adontoo/samsung/toolchain/llvm-arm-toolchain-ship/10.0/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifdef CONFIG_CFP
CFP_CC		?= /home/adontoo/samsung/toolchain/llvm-arm-toolchain-ship/10.0/bin/clang
